                ...
                <div className="flex gap-2 items-center cursor-pointer">
                  <TooltipCustom content={getValue()?.address}>
                    <Link
                      ...
                      className="text-blue dark:text-[#6AB5DB] border-cell-value px-2 dark:hover:bg-[#352b15] hover:bg-[#fbf1dc]   rounded-md  duration-150 ease-in-out"
                    >
                      {getValue()?.name}
                    </Link>
                  </TooltipCustom>
          ...
          text={
            <div className="flex flex-col gap-1 cursor-pointer">
              ...
              <div className={` relative w-full h-[2px] bg-[#e9ecef] `}>
                <div
                  className={`absolute h-full  top-0 left-0 bg-blue`}
                  style={{
