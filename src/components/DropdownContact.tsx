    ...
    >
      <div>
        <button
          ...
          type="button"
          className={`inline-flex w-full justify-between gap-x-1.5 rounded-[4px] bg-white border-[2px] border-[#DCDCDC] px-3 py-2 text-sm shadow-sm whitespace-nowrap ${className}`}
        >
