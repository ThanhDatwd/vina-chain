...
const productLinks = [
  { label: "Advertise", href: "/contactusadvertise" },
  { label: "Explorer-as-a-Service (EaaS)", href: "/eaas" },
  { label: "API Plans", href: "/apis" },
  { label: "Priority Support", href: "/priority-support" },
];
...
export const FooterScan: FC<Props> = () => {
  ...
  return (
    <div className="grid grid-cols-12 justify-between md:pt-8 py-8 container-xxl p-4 px-4  md:p-8 lg:py-6 lg:px-14">
        ...
        <div className="col-span-1 mb-10 mb-md-0">
          ...
          <ul className="list-unstyled list-sm-space fs-sm mb-0">
            {companyLinks.map((link, index) => (
              <li key={index}>
                <a className="link-dark text-xs" href={link.href}>
                  {link.label}
                </a>
              </li>
            ))}
