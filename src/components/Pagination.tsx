...
export const Pagination = ({
  ...
  return (
    <div className="flex gap-1 items-center">
      ...
      <span className=" bg-white_98  dark:bg-gray800 h-[28.8px] flex items-center justify-center px-2 border border-[#bdc5d133] text-gray550 dark:text-gray500 rounded-md text-[12.56px]">{`Page ${2}/1000`}</span>
      <button
