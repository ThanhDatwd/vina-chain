...
export default function BugBounty() {
  ...
  return (
    <ScanLayout containerStyle="bg-[#FAFAFA] dark:bg-primaryDark">
      <div className="flex flex-col items-center px-3 lg:px-10 py-10 lg:py-16 bg-[#fbfbfd]">
        <div
          className="w-full lg:w-[1012px]"
          style={{ boxShadow: "0 0.5rem 1.2rem rgb(189 197 209 / 20%)" }}
        >
          <div className="relative p-8 pb-8 lg:pt-10 lg:pb-14 bg-[#081d35] rounded-xl">
